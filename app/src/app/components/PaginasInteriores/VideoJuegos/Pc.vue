      ...
      <div id="carouselPc" class="carousel slide" data-ride="carousel" data-interval="0">
        ...
        <div class="carousel-inner">
          <div class="item carousel-item active">
            <div class="row">
             <Item
                  v-for="item in Productos_Pc_accion"
                  :key="item._id"
                  :invId="item._id"
                  :name="item.titulo"
                  :image="item.foto"
      ...
      <div id="carouselxbox" class="carousel slide" data-ride="carousel" data-interval="0">
        ...
        <div class="carousel-inner">
          <div class="item carousel-item active">
            <div class="row">
              <Item
              v-for="item in Productos_Pc_aventura"
              :key="item._id"
              :invId="item._id"
              :name="item.titulo"
              :image="item.foto"
      ...
      <div id="carouselxbox" class="carousel slide" data-ride="carousel" data-interval="0">
        ...
        <div class="carousel-inner">
          <div class="item carousel-item active">
            <div class="row">
              <Item
              v-for="item in Productos_Pc_deporte"
              :key="item._id"
              :invId="item._id"
              :name="item.titulo"
              :image="item.foto"
      ...
      <div id="carouselxbox" class="carousel slide" data-ride="carousel" data-interval="0">
        ...
        <div class="carousel-inner">
          <div class="item carousel-item active">
            <div class="row">
              <Item
              v-for="item in Productos_Pc_conduccion"
              :key="item._id"
              :invId="item._id"
              :name="item.titulo"
              :image="item.foto"
      ...
      <div id="carouselxbox" class="carousel slide" data-ride="carousel" data-interval="0">
        ...
        <div class="carousel-inner">
          <div class="item carousel-item active">
            <div class="row">
              <Item
              v-for="item in Productos_Pc_estrategia"
              :key="item._id"
              :invId="item._id"
              :name="item.titulo"
              :image="item.foto"
      ...
      <div id="carouselxbox" class="carousel slide" data-ride="carousel" data-interval="0">
        ...
        <div class="carousel-inner">
          <div class="item carousel-item active">
            <div class="row">
              <Item
              v-for="item in Productos_Pc_rpg"
              :key="item._id"
              :invId="item._id"
              :name="item.titulo"
              :image="item.foto"
